...
\begin{document} 
    ...
    \input{Tex/Pretexto/FolhaDeRosto} %% Página obrigatória

    \input{Tex/Pretexto/FolhaAprovacao} %% Página obrigatória

    \input{Tex/Pretexto/Dedicatoria.tex} %% Página opcional

    \input{Tex/Pretexto/Agradecimentos.tex} %% Página opcional

    \input{Tex/Pretexto/Epigrafe.tex} %% Página opcional

    \input{Tex/Pretexto/Resumo.tex} %% Página obrigatória

    \input{Tex/Pretexto/ResumoEstrangeiro.tex} %% Página obrigatória
    ...
    \newpage
    % \nocite{*}
    \printbibliography[heading=bibintoc, title={\hfill REFERÊNCIAS \hfill}]
\end{document}
